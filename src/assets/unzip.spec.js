...
const TEST_ZIP = {
  data: Buffer.from(
    'UEsDBAoAAAAAAOKAxFbxsdyoAgAAAAIAAAAHABwAY29tbWFuZFVUCQADGDh8ZBg4fGR1eAsAAQT1AQAABBQAAADazFBLAQIeAwoAAAAAAOKAxFbxsdyoAgAAAAIAAAAHABgAAAAAAAEAAACkgQAAAABjb21tYW5kVVQFAAMYOHxkdXgLAAEE9QEAAAQUAAAAUEsFBgAAAAABAAEATQAAAEMAAAAAAA',
    'base64'
  ),
  sha256: {
...
describe('unzip()', () => {
  ...
  it('should download resource and unzip to given binPath', async () => {
    ...
    await expect(createFileHash('sha256', './bin/command')).resolves.toEqual(
      TEST_ZIP.sha256['command']
    );
  });
